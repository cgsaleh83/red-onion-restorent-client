...
import {  googleSingIn, useAuth, resetPassword } from './useAuth';
import imag from '../../Images/ICON/google.png';
    ...
    return (
        <div className="sign-up">
            <div className="container">
                ...
                {/* Google Login */}
                <div className="Google_button_group">
                    <button onClick={handleClickWithGoogle} className="btn  btn-block google" type="submit"><span>Sign In With Google</span></button>
                    <img src={imag} alt="" />
                </div>
